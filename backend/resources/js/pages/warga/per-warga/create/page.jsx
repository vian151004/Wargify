            ...
            <div className="p-8 max-w-4xl mx-auto">
                ...
                <div className="flex flex-col items-center mb-10">
                    ...
                    <div className="flex items-center gap-4">
                        <h2 className="text-3xl font-bold text-gray-900">Nama Lengkap</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6 mb-10">
                    <div className="space-y-2">
                        ...
                        <Input id="username" placeholder="username" className="border-gray-300 focus-visible:ring-[#00468B]" />
                    </div>
                    ...
                    <div className="space-y-2">
                        <div className="grid grid-cols-[1fr_2fr] gap-4">
                            <div>
                                ...
                                <Input id="umur" placeholder="0" type="number" className="border-gray-300 focus-visible:ring-[#00468B]" />
                            </div>
                            <div>
                    ...
                    <div className="space-y-2">
                        ...
                        <Input id="nama" placeholder="nama lengkap" className="border-gray-300 focus-visible:ring-[#00468B]" />
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <Input id="nohp" placeholder="0" className="border-gray-300 focus-visible:ring-[#00468B]" />
                    </div>
