...
export default function EditJadwalRondaPage() {
    ...
    const [titikKumpulId, setTitikKumpulId] = useState("cp_1");
    ...
    const [checkpoints, setCheckpoints] = useState([
        { id: "cp_1", nama: "Pos Ronda", status: "Belum di-scan" },
        { id: "cp_2", nama: "Pos Ronda", status: "Belum di-scan" },
        { id: "cp_3", nama: "Pos Ronda", status: "Belum di-scan" },
        { id: "cp_4", nama: "Pos Ronda", status: "Belum di-scan" },
        { id: "cp_5", nama: "Pos Ronda", status: "Belum di-scan" },
    ]);
        ...
        <DashboardLayout>
            ...
            <div className="p-8 max-w-4xl">
                ...
                <div className="flex items-center gap-4 mb-2">
                    ...
                    <h1 className="text-3xl font-bold text-gray-900 tracking-tight">Edit Jadwal Ronda</h1>
                </div>
                ...
                <div className="ml-12 space-y-6 max-w-2xl mb-12">
                    <div className="grid grid-cols-[150px_1fr] items-center gap-4">
                        ...
                        <Input id="tanggal" type="date" defaultValue="2026-04-29" className="border-gray-300 focus-visible:ring-[#00468B]" />
                    </div>
                ...
                <div className="ml-12 mb-12">
                    ...
                    <div className="rounded-xl border border-gray-150 overflow-hidden bg-white shadow-sm">
                        <RadioGroup value={titikKumpulId} onValueChange={setTitikKumpulId}>
                            <Table>
                                <TableHeader className="bg-muted/50">
                                    <TableRow>
                                        <TableHead className="font-semibold text-muted-foreground">Nama Lokasi ↑↓</TableHead>
                                        <TableHead className="font-semibold text-muted-foreground">Status</TableHead>
                                        <TableHead className="font-semibold text-muted-foreground w-36 text-center">Titik Kumpul</TableHead>
